...
try
    ...
    if ~isfile(fullfile(obj.data_folder,num2str(obj.metab_expnb),'fid'))
        metab_filename = fullfile(obj.data_folder,num2str(obj.metab_expnb),'pdata','1','fid_proc.64');
        ref_filename = fullfile(obj.data_folder,num2str(obj.ref_expnb),'pdata','1','fid_proc.64');
    % Paravision 1.1
    else
